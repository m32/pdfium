...
//
 float  FPDFText_GetCharAngle(FPDF_TEXTPAGE text_page,
                                                      int index);
...
//          parameters to 0.
//
 FPDF_BOOL  FPDFText_GetRect(FPDF_TEXTPAGE text_page,
                                                     int rect_index,
                                                     double* left,
                                                     double* top,
                                                     double* right,
...
//
 FPDF_BOOL  FPDFLink_GetRect(FPDF_PAGELINK link_page,
                                                     int link_index,
                                                     int rect_index,
                                                     double* left,
                                                     double* top,

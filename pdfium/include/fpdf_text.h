...
//          "em size").
//
extern double  FPDFText_GetFontSize(FPDF_TEXTPAGE text_page,
                                                      int index);
...
//
extern int  FPDFText_GetFontWeight(FPDF_TEXTPAGE text_page,
                                                     int index);
...
//
extern float  FPDFText_GetCharAngle(FPDF_TEXTPAGE text_page,
                                                      int index);
...
//
extern FPDF_BOOL  FPDFText_GetCharBox(FPDF_TEXTPAGE text_page,
                                                        int index,
                                                        double* left,
                                                        double* right,
                                                        double* bottom,
...
//
extern FPDF_BOOL  FPDFText_GetMatrix(FPDF_TEXTPAGE text_page,
                                                       int index,
                                                       FS_MATRIX* matrix);
...
//          FPDFText_GetCharBox().
//
extern int  FPDFText_GetText(FPDF_TEXTPAGE text_page,
                                               int start_index,
                                               int count,
...
//
extern int  FPDFText_CountRects(FPDF_TEXTPAGE text_page,
                                                  int start_index,
                                                  int count);
...
//          parameters to 0.
//
extern FPDF_BOOL  FPDFText_GetRect(FPDF_TEXTPAGE text_page,
                                                     int rect_index,
                                                     double* left,
                                                     double* top,
                                                     double* right,
...
//          it.
//
extern int  FPDFText_GetBoundedText(FPDF_TEXTPAGE text_page,
                                                      double left,
                                                      double top,
                                                      double right,
                                                      double bottom,
...
//          is an empty string.
//
extern int  FPDFLink_GetURL(FPDF_PAGELINK link_page,
                                              int link_index,
                                              unsigned short* buffer,
                                              int buflen);
...
//
extern int  FPDFLink_CountRects(FPDF_PAGELINK link_page,
                                                  int link_index);
...
//
extern FPDF_BOOL  FPDFLink_GetRect(FPDF_PAGELINK link_page,
                                                     int link_index,
                                                     int rect_index,
                                                     double* left,
                                                     double* top,
